...
define('TEMPLATE_PATH', '/wp-content/plugins/cyclone-slider-2/templates/caption/');
?>
<div tabindex="0" class="cycloneslider cycloneslider-template-caption cycloneslider-width-<?php echo esc_attr( $slider_settings['width_management'] ); ?>"
    ...
    >
    <div class="cycloneslider-slides cycle-slideshow-bg"></div>
            ...
            <?php if ( 'image' == $slide['type'] ) : ?>
                <div class="cycloneslider-slide" <?php echo cyclone_slide_settings($slide, $slider_settings); ?>>
                    <?php if( '_blank' == $slide['link_target'] ): ?>
                        <?php $link_target = '_blank'; ?>
                    <?php else : ?>
                        <?php $link_target = '_self'; ?>
                    <?php endif; ?>
                    <?php if(!empty($slide['title']) ) : ?> 
                        <div class="cycloneslider-caption">
                            <div class="cycloneslider-caption-title">
                                <?php if( $slide['link'] != '' ) : ?>
